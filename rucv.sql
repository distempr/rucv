...
CREATE TABLE sentence (id INTEGER PRIMARY KEY, content TEXT, selected INTEGER, score INTEGER, original_filename TEXT, new_filename TEXT, crc INTEGER, speaker INTEGER, upvotes INTEGER, downvotes INTEGER, UNIQUE(crc, speaker));
